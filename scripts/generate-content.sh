...
usage() {
    ...
    echo ""
    echo "Options:"
    echo "  -s, --ssg NAME        SSG name (hugo, zola, jekyll, blades, hwaro, eleventy, pelican, hexo, astro)"
...
main() {
    ...
    case $SSG in
        ...
        *)
            ...
            log_error "Supported SSGs: hugo, zola, jekyll, blades, hwaro, eleventy, pelican, hexo, astro"
            exit 1
            ;;
    esac
